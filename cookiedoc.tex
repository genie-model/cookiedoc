...
\begingroup
\thispagestyle{empty}
\AddToShipoutPicture*{\put(0,150){\includegraphics[scale=0.225]{cover}}} % Image background
\centering
\vspace*{7.5 cm}
\par\normalfont\fontsize{36}{36}\sffamily\selectfont
\textcolor[rgb]{1,1,1}{The Magical Tome of \textit{.cookie}s}\par % title
\vspace*{1.0 cm}
\par\normalfont\fontsize{27}{27}\sffamily\selectfont
\textcolor[rgb]{0,1,0}{\textit{c}GENIE.cookie user-manual and introduction to Earth system modeling}\par % title2
\vspace*{3.5 cm}
